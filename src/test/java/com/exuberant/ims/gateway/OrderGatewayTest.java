...
public class OrderGatewayTest {
    ...
    public void saveOrder() throws Exception {
        Product p1 = new Product("TEST DESC 1", new BigDecimal(10.0), new BigDecimal(100.0), new BigDecimal(120.0), new BigDecimal(2.0), new BigDecimal(80.0), "100 GMS");;
        Product p2 = new Product("TEST DESC 2 ", new BigDecimal(100.0), new BigDecimal(100.0), new BigDecimal(130.0), new BigDecimal(2.0), new BigDecimal(100.0), "200 GMS");;
